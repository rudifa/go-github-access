...
var rootCmd = &cobra.Command{
	Use:   "go-github-access",
	Short: "Demo of GitHub API access using Go",
	Long:  `Demo of GitHub API access using Go`,
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.go-channel-demo.yaml)")
